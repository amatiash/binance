...
class BinanceRest {
    ...
    aggTrades(query = {}, callback) {
        ...
        console.warn('By end of Q1 2020, this endpoint will be removed from the API');
    ...
    depth(query = {}, callback) {
        ...
        return this._makeRequest(query, callback, 'api/v3/depth');
    }
    ...
    systemStatus(callback) {
        ...
        return this._makeRequest(query, callback, 'wapi/v3/systemStatus.html');
    }
    ...
    marginAsset(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'sapi/v1/margin/asset', 'SIGNED');
    }
    ...
    marginCancelOrder(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'sapi/v1/margin/order', 'SIGNED', 'DELETE');
    }
